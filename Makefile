...
OPT=-O3
LDFLAGS=-L./ -std=c++14
LIBSOURCES=type.cpp variable.cpp expr.cpp stmt.cpp gen_policy.cpp sym_table.cpp master.cpp options.cpp
...
HEADERS=type.h variable.h ir_node.h expr.h stmt.h gen_policy.h sym_table.h master.h options.h
